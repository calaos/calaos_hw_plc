...
onewire_bus_init();
	...
	void onewire_bus_write(onewire_bus_t *onewire, int8_t v, uint8_t power = 0);

	void onewire_bus_write_bytes(onewire_bus_t *onewire, const uint8_t *buf, uint16_t count, bool power = 0);
